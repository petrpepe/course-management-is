...
function Lessons() {
  ...
  return (<>
    ...
    <Search getData={getLessons} />
    {(user.roles.includes("admin") || user.roles.includes("lector")) && <Button component={ReactLink} to="/lessons/create" sx={{ color: '#fff' }}>Create new Lesson</Button>}
