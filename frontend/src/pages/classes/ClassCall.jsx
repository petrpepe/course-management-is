...
function ClassCall() {
  ...
  const { timetables, status: timetableStatus } = useGetData("timetables", getTimetables, resetTimetables, {ids: timetableId})
  const user = useSelector(state => state.auth.user)

  if (timetableStatus === Status.Loading || timetableStatus === Status.Idle) {
